        ...
        <main className="!pt-0">
            <nav className="resume-nav">
                <Link to="/" className="back-button">
                    <img src="/icons/back.svg" alt="Back to Home" className="w-2.5 h-2.5" />
            ...
            <div className="flex flex-row w-full max-lg:flex-col-reverse">
                ...
                <section className="feedback-section">
                    ...
                    {feedback ? (
                        <div className="flex flex-col gap-8 mt-6 text-gray-800 animate-in fade-in duration-1000">
                            <Summary feedback={feedback} />
                            <Ats score={feedback.ATS.score || 0} suggestions={feedback.ATS.tips || []}/>
                            <Details feedback={feedback} />
                        </div>
                    ) : (
                        <img src='/images/resume-scan-2.gif' className="w-full mt-10"/>
                    )}
                </section>
            </div>
        </main>
